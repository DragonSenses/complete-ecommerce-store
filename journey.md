...
Similarly, we can display the product color in the same way. Butt instead of simply interpolating the products color in text we are going to display the actual color.
